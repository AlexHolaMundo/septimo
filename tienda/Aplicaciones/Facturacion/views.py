...
def guardarCliente (request):
    ...
    nuevoCliente=Cliente.objects.create(cedula=cedula, nombre=nombre, apellido=apellido, fechas_nacimiento=fechas_nacimiento, correo=correo, direccion=direccion,tipo=tipoSeleccionado,)
